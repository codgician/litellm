...
def test_github_copilot_mai_code_1_flash_picker_pricing(_local_model_cost_map, model):
...
def test_github_copilot_mai_code_1_1_flash_pricing(_local_model_cost_map):
...
def test_github_copilot_gemini_flash_pricing(_local_model_cost_map, model: str):
    model_info = litellm.model_cost.get(model)
...
def test_github_copilot_claude_opus_5_pricing(_local_model_cost_map):
